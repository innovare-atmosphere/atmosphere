...
export default function Home({ allProvidersData }) {
  return (
    ...
    <div className="flex flex-row-reverse space-x-4 space-x-reverse p-2">
        <a className="flex text-gray-400 items-center border px-4 py-2 hover:text-gray-600 hover:shadow" href="https://github.com/boriscougar/atmosphere/">
           Github
        </a>
    </div>
      <div className="flex flex-col items-center justify-center min-h-screen py-2">
        ...
        <main className="flex flex-col items-left justify-center w-full flex-1 px-20 text-center">
          ...
          <p className="mt-3 text-2xl">
            Use and launch Free and Open Source software sass easy.
          </p>
          <div className="flex flex-row mt-6">
            ...
            <div className="flex flex-col space-y-4 pb-4 w-4/5 border">
            {allProvidersData.map(({ id, name, url, logo, contentHtml }) => (
              <div className="flex border m-4 mb-0 rounded" key={id}>
                ...
                <div className="text-justify mx-1 pl-2 pt-2">
                  <a className="flex text-black-400 text-lg font-medium pb-2" href={url}>
                    {name}
